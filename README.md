...
<a href="docs/images/movie-overlay-explainer.png">
  <img src="docs/images/movie-overlay-explainer.png" alt="Movie overlay anatomy — 4K, Extended Edition, HDR, rating" width="400">
</a>
...
<a href="docs/images/anime-poster-explainer.png">
  <img src="docs/images/anime-poster-explainer.png" alt="Anime poster anatomy — Peacock logo, RETURNING ribbon, rating" width="400">
</a>
...
<a href="docs/images/episode-title-card-explainer.png">
  <img src="docs/images/episode-title-card-explainer.png" alt="Episode title card anatomy — rating, watched status, season/episode label, runtime" width="400">
</a>
...
| ✓ checkmark | Top-right | Watched status | Plex built-in |
...
<a href="docs/images/anime-episode-title-card-explainer.png">
  <img src="docs/images/anime-episode-title-card-explainer.png" alt="Anime episode title card anatomy — rating, watched status, season/episode label, CANON tag, runtime" width="400">
</a>

| Badge | Location | What it shows | Config file | Source |
|-------|----------|---------------|-------------|--------|
| 8.0 | Top-left | Episode rating (green chip) | `3-audience_rating_episodes.yml` | [jhn322](https://github.com/jhn322/kometa-config) + customized |
| ✓ | Top-right | Watched status | Plex built-in | Kometa |
| SEASON 1 • EPISODE 1 | Bottom-center | Episode label | Posterizarr title cards | [fscorrupt/posterizarr](https://github.com/fscorrupt/posterizarr) |
...
<a href="docs/images/collections-movies.png">
  <img src="docs/images/collections-movies.png" alt="Movie collections — genres, streaming, franchises, IMDb/Trakt/Letterboxd, themes" width="1024">
</a>
...
<a href="docs/images/collections-actors.png">
  <img src="docs/images/collections-actors.png" alt="Actor collections — custom B&W poster style via posterizarr" width="1024">
</a>
