...
| **TSSK-Kabeb** | [netplexflix/Overlays](https://github.com/netplexflix/Overlays) (`TSSK-Kabeb/`) | Streaming network logos and Kabeb-style trending badge artwork |
| **County** | [Naveen11695/County](https://github.com/Naveen11695/County) | Movie trending top-10 badge images (used in UMTK movie overlays) |
...
|---------|------|--------------|
| **netplexflix standalone** | [netplexflix/Overlays](https://github.com/netplexflix/Overlays) (standalone) | UMTK manages Kabeb overlays; no separate Overlays container |
...
| Image assets | jmxd badges, TSSK-Kabeb logos, County trending | Bundled in `assets/`; some Kabeb logos load from GitHub raw URLs |
